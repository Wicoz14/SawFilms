...
function validaractualizacion(){
    let contraseñaact = document.getElementById("actualizarcontraseña").value
    let confirmarcontraseñaact = document.getElementById("confirmarnuevacontraseña").value
    
    ssww=true;

    if (contraseñaact.length < 6) {
        alert("la contraseña debe tener al menos 6 caracteres")
        ssww = false
    }
    if (contraseñaact!=confirmarcontraseñaact){
        alert("los contraseñas inscritas son distintas en ambos campos")
        ssww= false
    }
    if (ssww){
